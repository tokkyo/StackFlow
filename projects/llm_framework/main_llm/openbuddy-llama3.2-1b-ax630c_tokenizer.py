...
if __name__ == "__main__":
    ...
    args.add_argument('--model_id', type=str, default='openbuddy_tokenizer')
    args.add_argument('--content', type=str, default='You(assistant) are a helpful, respectful and honest INTP-T AI Assistant named Buddy. You are talking to a human(user).')
